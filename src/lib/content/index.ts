export const CONFIG = {
	companyName: "Harvey",
	description: "Harvey delivers faster legal work by leveraging domain-specific AI models that transform complex professional tasks into streamlined workflows, enabling lawyers to handle 35% more cases while reducing manual effort by 80%.",
	image: "/og.png",
	url: "https://harvey.ai",
	...
	funding: {
		...
		investors: ["OpenAI Startup Fund", "Kleiner Perkins", "GV (Google Ventures)", "Elad Gil", "Conviction Partners"]
	},
	founders: [
		{
	...
	keyMetrics: {
		...
		workQualityImprovement: "Over 80% of legal professionals report significant improvements in work quality and speed"
	},
	security: ["SOC2 II", "ISO 27001", "GDPR", "CCPA compliance", "Single-tenant architecture", "Zero training on customer data"],
